...
/* package ninety-nine-0.1.0.0 */
#ifndef VERSION_ninety_nine
#define VERSION_ninety_nine "0.1.0.0"
#endif /* VERSION_ninety_nine */
#ifndef MIN_VERSION_ninety_nine
#define MIN_VERSION_ninety_nine(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ninety_nine */
...
#define CURRENT_COMPONENT_ID "ninety-nine-0.1.0.0-6JiLl25S0wr8iM0UDuJEgu-ninety-nine"
